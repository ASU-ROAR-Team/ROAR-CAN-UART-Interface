...
def extract_10bit_segments(data: List[int], num_segments: int) -> List[int]:
        """
...
bytes = [0b10101100, 0b01100110, 0b11001100, 0b10101010]

segments = extract_10bit_segments(bytes, 3)

print([bin(segment) for segment in segments])